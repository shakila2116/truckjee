<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="header">Transporter</li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="{{ set_active('admin/transporter/create') }}"><a href="{{ url('admin/transporter/create') }}"><i class="fa fa-user"></i> <span>Create Transporter</span></a></li>
                <li class="{{ set_active('admin/transporter/list') }}"><a href="{{ url('admin/transporter/list') }}"><i class="fa fa-users"></i> <span>View Transporters</span></a></li>
            </ul>
        </li>
    </ul>
    <!-- /.sidebar-menu -->
